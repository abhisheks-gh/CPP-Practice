...
/*
 ...
 the function call, copies the arguments of the function on the stack and finally transfer control to the specified function. 
*/
...
// If we are writing function definitions(small) inside a class then compiler automatically
